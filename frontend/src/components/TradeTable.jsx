...
export const TradeTable = () => {
    ...
    return (
        <div className="overflow-y-auto max-h-80 shadow-md mt-10 w-[50%] bg-[#101010] text-white text-center text-5xl rounded-lg">
            {!isLoading && <table className="w-full text-sm text-left light:text-gray-500 text-gray-400">
                ...
                <tbody>
                    {trade.map((coin) => (
                        <tr key={coin.name} className="light:bg-white light:border-b bg-SideBarColor border-gray-700 cursor-pointer">
                            <th
                                scope="row"
            ...
            {isLoading && <div role="status" className="max-w-md w-[700px] p-4 space-y-4  divide-y rounded-lg max-h-[80] shadow animate-pulse divide-gray-700 md:p-6 border-gray-700">
