    ...
    return (
        <div className="bg-SideBarColor h-screen fixed w-60 p-6 max-lg:hidden">
            <div className="flex gap-2 items-center text-white">
                <img className="w-16 h-16" src="https://cdn4.iconfinder.com/data/icons/crypto-currency-and-coin-2/256/bitoin_btc_coin_crypto-256.png" alt="" />
            ...
            <ul className="mt-8">
                ...
                <NavLink to={"/search"} className="flex gap-2 mt-5 items-center text-gray-400 font hover:text-white cursor-pointer" style={({ isActive }) => {
                    return {
                        color: isActive ? "white" : "",
                    };
                }}>
